...
export const websiteURL: string = "https://www.pdf-to-jpg-converter.com";
...
export const licenseOptions = [
  {
    ...
    price: "$24.95 USD",
    paymentLink:
      "https://frameworkteam.onfastspring.com/pdf-to-jpg-converter-one-computer-license",
  },
  {
    licenseType: "TWO Computers License",
    price: "$39.95 USD",
    paymentLink:
      "https://frameworkteam.onfastspring.com/pdf-to-jpg-converter-two-computers-license",
  },
  {
    licenseType: "THREE Computers License",
    price: "$44.95 USD",
    paymentLink:
      "https://frameworkteam.onfastspring.com/pdf-to-jpg-converter-three-computers-license",
  },
  {
    licenseType: "FIVE Computers License",
    price: "$64.95 USD",
    paymentLink:
      "https://frameworkteam.onfastspring.com/pdf-to-jpg-converter-five-computers-license",
  },
  {
    licenseType: "TEN Computers License",
    price: "$109.95 USD",
    paymentLink:
      "https://frameworkteam.onfastspring.com/pdf-to-jpg-converter-ten-computers-license",
  },
  {
    licenseType: "UNLIMITED Computers License",
    price: "$224.95 USD",
    paymentLink:
      "https://frameworkteam.onfastspring.com/pdf-to-jpg-converter-unlimited-computers-license",
  },
];
